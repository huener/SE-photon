...
class View extends JPanel
{
	...
	//Play by play action will be shown in a window on the main screen. 
	//The events can scroll off as the window fills.
	void createTeamFeeds(){
		...
		JTextArea redTeamText = new JTextArea(17,37);
		...
		JTextArea greenTeamText = new JTextArea(17,37);
	...
	//Helper method to the createTeamFeed. The text that will fill the action screen window.
	String fillScrollPane(){
